 ...
 *    
 *    
 *    Now i am talking about collection hierarchy:=>
 *    
 *     Iterable(i)=>collection(i)=>list(i)=>set(i)=>queue=>
 *    
 *     list(i)=>implements=>ArrayList(c),LinkedList(c),Stack=>extends vector(c)
 *     
 *     Set(i)=>implements HashSet(c)=>extends LinkedHashSet(c),extends SortedSet(i)=>Navigable(i)=>implements TreeSet(c)
 *     
 *     Queue(i)=>implements PriorityQueue(c),LinkedList(c),BlockingQueue(c)
 *     
 *    lets see the Collection Hierarchy=> 
 *    
 * 
 */
